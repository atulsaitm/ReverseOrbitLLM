...
Run with: reverseorbitllm interactive
"""
...
from reverseorbitllm.presets import (
    ModelPreset,
    get_presets_by_tier,
)
...
def run_interactive():
    ...
    console.print(
        Panel.fit(
            "[bold white on blue]  ReverseOrbitLLM — Master Ablation Suite  [/bold white on blue]\n\n"
    ...
    quantization = None
    try:
        from reverseorbitllm import device as _dev
    ...
    # Build config
    from reverseorbitllm.config import StudyConfig, ModelConfig, DatasetConfig, StrategyConfig
