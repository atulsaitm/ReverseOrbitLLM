...
- Built-in: 512 prompts bundled with ReverseOrbitLLM across 7 severity tiers
...
_register(DatasetSource(
    key="builtin",
    label="ReverseOrbitLLM Prompt Corpus (512 pairs)",
    description="ReverseOrbitLLM prompt set — 512 harmful/harmless pairs across 7 severity tiers",
    estimated_count=512,
