...
for abliteration.  ReverseOrbitLLM pushes this further by:
...
6. **Warm-start from analysis**: Uses ReverseOrbitLLM's analysis-based heuristics
...
def run_bayesian_optimization(
    ...
    from reverseorbitllm.abliterate import _ATTN_OUT_NAMES, _FFN_OUT_NAMES
    ...
    study = optuna.create_study(
        ...
        sampler=sampler,
        study_name="reverseorbitllm_parametric_optimization",
    )
