"""Telemetry-driven adaptive defaults for ReverseOrbitLLM.
...
Data flow:
  HF Hub (ReverseOrbitLLM-TELEMETRY)  ──►  fetch_hub_records()
       │                                      │
       ▼                                      ▼
...
def _fetch_all_records() -> list[dict[str, Any]]:
    ...
    # Local records
    try:
        from reverseorbitllm.telemetry import read_telemetry
    ...
    # Hub records
    try:
        from reverseorbitllm.telemetry import fetch_hub_records
