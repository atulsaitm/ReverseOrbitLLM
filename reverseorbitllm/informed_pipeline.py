...
Closes the feedback loop between ReverseOrbitLLM's 15 analysis modules (#3)
...
class InformedAbliterationPipeline(AbliterationPipeline):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            # Set informed defaults: multi-direction SVD + Bayesian opt
            n_directions=4,
    ...
    def _analyze_sparsity(self):
        ...
        from reverseorbitllm.strategies.utils import (
            get_ffn_module,
            get_layer_modules,
        )
    ...
    def _derive_configuration(self):
        ...
        if insights.cone_is_polyhedral and insights.cone_dimensionality > 2.0:
            ...
            # Linear cone — scale direction count with dimensionality
    ...
    def _rebirth_informed(self) -> Path:
        ...
        metadata = {
            ...
            "references": [
                ...
                "ReverseOrbitLLM: Analysis-informed abliteration pipeline (novel)",
            ],
        }
