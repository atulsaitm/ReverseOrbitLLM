...
\item \textbf{Code availability}: Full source code released under AGPL-3.0 at \url{https://github.com/elder-plinius/ReverseOrbitLLM}. Version 0.1.0 archived on Zenodo (DOI pending).
