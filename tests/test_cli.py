"""CLI dispatch tests for reverseorbitllm.cli.main().
...
from reverseorbitllm.cli import main
...
class TestCLIDispatch:
    ...
    def test_models_command(self):
        ...
        with patch("reverseorbitllm.cli.console") as mock_console:
            main(["models"])
    ...
    def test_obliterate_valid_methods(self):
        ...
        for method in valid_methods:
            ...
            with patch("reverseorbitllm.cli._cmd_abliterate") as mock_cmd:
    ...
    def test_help_flag(self):
        ...
        output = buf.getvalue()
        assert "reverseorbitllm" in output.lower() or "usage" in output.lower()
    ...
    def test_interactive_command_exists(self):
        ...
        with patch("reverseorbitllm.cli._cmd_interactive") as mock_cmd:
            main(["interactive"])
            mock_cmd.assert_called_once()
