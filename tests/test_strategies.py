...
from reverseorbitllm.strategies.base import AblationSpec
from reverseorbitllm.strategies.registry import STRATEGY_REGISTRY, get_strategy
...
class TestHeadPruning:
    ...
    def test_apply_zeros_head(self, handle):
        ...
        from reverseorbitllm.strategies.utils import get_layer_modules, get_attention_module
...
class TestFFNAblation:
    ...
    def test_apply_zeros_ffn(self, handle):
        ...
        from reverseorbitllm.strategies.utils import get_layer_modules, get_ffn_module
...
class TestEmbeddingAblation:
    ...
    def test_apply_zeros_dims(self, handle):
        ...
        from reverseorbitllm.strategies.utils import get_embedding_module
