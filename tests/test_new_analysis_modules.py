...
from reverseorbitllm.analysis.tuned_lens import (
    TunedLensTrainer,
    TunedLensProbe,
    RefusalTunedLens,
    TunedLensResult,
...
from reverseorbitllm.analysis.activation_patching import (
    ActivationPatcher,
    PatchingSite,
...
from reverseorbitllm.analysis.wasserstein_optimal import (
    WassersteinOptimalExtractor,
    WassersteinDirectionResult,
    WassersteinComparisonResult,
    MultiLayerWassersteinResult,
)
from reverseorbitllm.analysis.bayesian_kernel_projection import (
...
class TestModuleImports:
    def test_all_new_modules_importable(self):
        from reverseorbitllm.analysis import TunedLensTrainer
        from reverseorbitllm.analysis import RefusalTunedLens
        from reverseorbitllm.analysis import ActivationPatcher
        from reverseorbitllm.analysis import WassersteinOptimalExtractor
        from reverseorbitllm.analysis import BayesianKernelProjection
        from reverseorbitllm.analysis import SAEDecompositionPipeline
    ...
    def test_new_modules_in_all(self):
        import reverseorbitllm.analysis as analysis
