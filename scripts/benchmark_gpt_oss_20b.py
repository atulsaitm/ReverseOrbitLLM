#!/usr/bin/env python3
"""ReverseOrbitLLM GPT-OSS 20B Benchmark — Full Method Comparison.
...
from reverseorbitllm.evaluation.benchmarks import BenchmarkRunner, format_benchmark_report  # noqa: E402


def parse_args():
    parser = argparse.ArgumentParser(description="ReverseOrbitLLM GPT-OSS 20B Benchmark")
    parser.add_argument(
    ...
    parser.add_argument(
        "--output-dir", default="/tmp/reverseorbitllm_bench",
...
def main():
    ...
    print("=" * 60)
    print("  ReverseOrbitLLM GPT-OSS 20B BENCHMARK")
    print("=" * 60)
