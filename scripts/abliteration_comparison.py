...
Techniques compared:
  ...
  6. ReverseOrbitLLM basic — our current basic config
  7. ReverseOrbitLLM advanced — 4 directions, norm-preserve, reg=0.3
...
def run_experiment():
    ...
    experiments = [
        ...
        {
            "name": "ReverseOrbitLLM basic (1-dir, knee)",
            "source": "Ours",
            "n_directions": 1,
            "layer_selection": "knee",
            "regularization": 0.0,
        ...
        {
            "name": "ReverseOrbitLLM adv (4-dir, reg=0.3)",
            "source": "Ours",
            "n_directions": 4,
            "layer_selection": "knee",
            "regularization": 0.3,
        ...
        {
            "name": "ReverseOrbitLLM adv (4-dir, reg=0.1)",
            "source": "Ours (tuned)",
            "n_directions": 4,
            "layer_selection": "knee",
            "regularization": 0.1,
        ...
        {
            "name": "ReverseOrbitLLM adv (4-dir, reg=0.0)",
            "source": "Ours (tuned)",
            "n_directions": 4,
            "layer_selection": "knee",
            "regularization": 0.0,
...
def print_table(results: list[dict]):
    ...
    literature = [
        ...
        ("Wollschlager cones", "2025", "1-5", "per-layer", "—", "—", "RDO",
         "~98%→~1%", "Llama-3.1-8B"),
        ("ReverseOrbitLLM basic", "2025", "1", "knee", "No", "0.0", "No",
         "~95%→60%**", "Qwen-0.5B"),
        ("ReverseOrbitLLM advanced", "2025", "4", "knee", "Yes(fix)", "0.3", "No",
         "~95%→73%**", "Qwen-0.5B"),
        ("ReverseOrbitLLM surgical", "2025", "8", "knee", "Yes(fix)", "0.0", "Yes***",
    ...
    # ── Analysis ──────────────────────────────────────────────────────
    print(f"\n{'='*80}")
    print("ANALYSIS: WHY ReverseOrbitLLM UNDERPERFORMS AND WHAT TO FIX")
    print(f"{'='*80}")
...
1. MODEL SIZE: All published abliteration results use 7B+ models
   ...
   - ReverseOrbitLLM benchmarks: Qwen-0.5B (hidden_dim=896)
